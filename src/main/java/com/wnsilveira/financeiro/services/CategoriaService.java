...
import com.wnsilveira.financeiro.domain.dto.CategoriaDTO;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir uma categoria que possui lançamentos vinculados.");
		}
	}
